		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			if len(post.Media) == 1 {
				...
				if strings.Contains(post.Media[0], ".mp4") {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 43, Col: 47}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 49, Col: 47}
					}
				...
				for _, photo := range post.Media {
					...
					if strings.Contains(photo, ".mp4") {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 63, Col: 41}
						}
						...
						templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs("/api/files/" + photo)
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 69, Col: 41}
						}
			...
			var templ_7745c5c3_Var12 templ.SafeURL = templ.SafeURL(fmt.Sprintf("https://t.me/%s/%d", chat.TgUsername, post.TgMessageId))
			...
			if post.Title != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 94, Col: 23}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 104, Col: 67}
			}
			...
			for _, comment := range comments {
				...
				if comment.AuthorUsername != nil {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 111, Col: 64}
					}
					...
					templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%c", []rune(comment.AuthorTitle)[0]))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 115, Col: 64}
					}
				...
				if comment.AuthorUsername != nil {
					...
					var templ_7745c5c3_Var18 templ.SafeURL = templ.SafeURL(fmt.Sprintf("https://t.me/%s", *comment.AuthorUsername))
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 126, Col: 38}
					}
					...
					templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinStringErrs(comment.AuthorTitle)
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 130, Col: 38}
					}
				...
				templ_7745c5c3_Var21, templ_7745c5c3_Err = templ.JoinStringErrs(comment.Created.Time().Format("2006-01-02 15:04"))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 134, Col: 67}
				}
				...
				var templ_7745c5c3_Var22 templ.SafeURL = templ.SafeURL(fmt.Sprintf("https://t.me/%s/%d?comment=%d", chat.TgUsername, post.TgMessageId, comment.TgMessageId))
				...
				if comment.ReplyToComment != nil {
					...
					if comment.ReplyToComment.AuthorUsername != nil {
						...
						var templ_7745c5c3_Var23 templ.SafeURL = templ.SafeURL(fmt.Sprintf("https://t.me/%s", *comment.ReplyToComment.AuthorUsername))
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 147, Col: 53}
						}
						...
						templ_7745c5c3_Var25, templ_7745c5c3_Err = templ.JoinStringErrs(comment.ReplyToComment.AuthorTitle)
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `post_page.templ`, Line: 151, Col: 53}
						}
			...
			var templ_7745c5c3_Var26 templ.SafeURL = templ.SafeURL(fmt.Sprintf("https://t.me/%s/%d", chat.TgUsername, post.TgMessageId))
